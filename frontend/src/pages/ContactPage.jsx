...
export default function ContactPage() {
  ...
  return (
    <div className="w-full bg-[#F9FAFB] min-h-screen">
      <SEO
        title="Contact Us"
        description="Get in touch with padmeshwara for premium dehydrated vegetables and spices. Request quotations and explore international trade opportunities."
