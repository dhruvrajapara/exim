...
const TeamMembers = () => {
  ...
  const [sectionSetting, setSectionSetting] = useState({
    subtitle: 'OUR TEAM',
    title: 'Meet Our Team',
    description: 'Behind ABC Export is a dedicated team committed to delivering quality products, reliable export services, and long-term partnerships with global buyers.'
  });
    ...
    try {
      ...
      if (data) {
        setSectionSetting({
          ...
          description: data.description || 'Behind ABC Export is a dedicated team committed to delivering quality products, reliable export services, and long-term partnerships with global buyers.'
        });
      }
    } catch (error) {
