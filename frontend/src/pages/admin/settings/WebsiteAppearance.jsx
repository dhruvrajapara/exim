...
export default function WebsiteAppearance() {
  ...
  const [formData, setFormData] = useState({
    ...
    contact_company_name: 'ABC Export',
    ...
    sidebar_cta_description: 'Partner with ABC Export for premium dehydrated agriculture products delivered globally.',
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="mt-8 border-t pt-8">
                  ...
                  <div className="mb-6">
                    ...
                    <textarea name="sidebar_cta_description" value={formData.sidebar_cta_description} onChange={handleChange} rows="3" className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:border-[#0B63CE] outline-none" placeholder="Partner with ABC Export for premium dehydrated agriculture products delivered globally."></textarea>
                  </div>
                </div>
