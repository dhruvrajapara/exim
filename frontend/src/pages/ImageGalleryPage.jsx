      ...
      >
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            >
              {heroSetting?.title || "Image Gallery"}
            </h1>
            <p
            ...
            >
              {heroSetting?.description || "Discover the visual story behind padmeshwara's commitment to quality, sustainability, and global trade excellence."}
            </p>
          </motion.div>
        </div>
      </section>
