                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="flex items-start gap-3 mt-2">
                    ...
                    <label htmlFor="agreed" className="text-[14px] text-gray-500 leading-relaxed cursor-pointer">
                      I agree to the Privacy Policy and consent to {settings?.contact_company_name || 'ABC Export'} processing my personal data for the purpose of handling my inquiry.
                    </label>
                  </div>
