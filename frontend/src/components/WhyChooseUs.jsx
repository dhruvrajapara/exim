      ...
      <div className="container-custom">
        ...
        <Reveal delay={0} className="text-center mb-10 md:mb-12">
          ...
          <p className="text-[15px] md:text-[16px] lg:text-[18px] text-text/90 max-w-2xl mx-auto leading-relaxed">
            {sectionSetting?.description || 'At Bite Export, we deliver premium-quality agricultural products backed by reliable export services, international standards, and long-term business relationships.'}
          </p>
        </Reveal>
