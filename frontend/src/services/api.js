  ...
  try {
    ...
    return {
      footer: {
        ...
        copyright_text: `© ${new Date().getFullYear()} padmeshwara. All Rights Reserved.`,
        bottom_links: []
      },
      categories: [
        { id: 1, name: 'Dehydrated Onion', slug: 'dehydrated-onion' },
    ...
    return [
      {
        ...
        short_description: 'Leading padmeshwara with a vision to deliver premium Indian agricultural products to global markets.',
        social_links: {
...
export const fetchProductBySlug = async (slug) => {
  try {
    ...
    return {
      ...
      full_description: 'At padmeshwara, we ensure that our agricultural products are naturally grown, carefully harvested, and hygienically processed to retain their authentic aroma, taste, and nutritional value. This product is ideal for industrial food processing, catering, and retail packaging globally.',
...
export const fetchBlogs = async (filters = {}) => {
  try {
    ...
    const allBlogs = [
      ...
      { id: 5, title: 'Sustainable Farming Practices', slug: 'sustainable-farming', category: 'Company News', category_slug: 'company-news', featured_image: 'https://images.unsplash.com/photo-1599940778173-e276d4acb2bf?w=600&q=80', short_description: 'How padmeshwara partners with local farmers for sustainable agriculture.', published_date: '2026-06-05', reading_time: '5 min read', trending: false, author: 'Priya Patel' },
      ...
      { id: 11, title: 'Our New Facility in Gujarat', slug: 'new-facility-gujarat', category: 'Company News', category_slug: 'company-news', featured_image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&q=80', short_description: 'padmeshwara expands operations with a state-of-the-art processing facility.', published_date: '2026-04-15', reading_time: '3 min read', trending: false, author: 'Rohan Mehta' },
  ...
  try {
    ...
    return {
      ...
      content: `
        ...
        <h2>Conclusion</h2>
        <p>Exporting dehydrated vegetables in 2026 offers massive potential for those who prioritize food safety, premium packaging, and robust supply chain management. By partnering with a trusted merchant exporter like padmeshwara, you can navigate these complexities with ease.</p>
      `
    };
  }
};
