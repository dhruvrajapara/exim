...
class AboutSectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $section = AboutSection::create([
            'label' => 'About padmeshwara',
            'heading' => 'Empowering Global Trade Through Innovation & Trust',
            'description' => 'padmeshwara is a premier international trading enterprise bridging the gap between innovative manufacturers and global markets. We ensure seamless logistics, top-tier quality assurance, and robust supply chain networks to deliver excellence worldwide.',
            'image_path' => '/hero.png', // Using existing placeholder
            'image_alt' => 'padmeshwara Global Logistics',
